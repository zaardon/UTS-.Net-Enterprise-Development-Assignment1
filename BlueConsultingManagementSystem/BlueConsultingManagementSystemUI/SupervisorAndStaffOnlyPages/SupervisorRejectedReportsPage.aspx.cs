...
namespace BlueConsultingManagementSystemUI.SupervisorAndStaffOnlyPages.SuperVisorOnlyPages
{
    public partial class SupervisorRejectedReportsPage : System.Web.UI.Page
    {
        ...
        public void loadResults()
        {
            ...
            var selectCommand = new SqlCommand("SELECT distinct ReportName, ConsultantName, StatusReport, Location, Description, Amount, Currency, DateExpense FROM ExpenseDB WHERE StatusReport = 'Declined' AND Dept_Type = '" + userGroupMember + "'", connection);
